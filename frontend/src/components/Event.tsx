    ...
    <section id="event" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-1 lg:grid-cols-2">
          {events.map((ev, idx) => (
            <div key={idx} className="bg-gray-50 rounded-lg p-6 border border-gray-200 hover:border-primary/50 transition-colors cursor-pointer hover:bg-gray-50" onClick={() => {
                    window.location.href = `/event/${ev.slug}`;
                  }}>
        ...
        <div className="mt-8 text-center">
          <a href="/events" className="inline-block px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors">
            View All Events
          </a>
        </div>
      </div>
